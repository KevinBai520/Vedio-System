        ...
        <div id="page_content">
            ...
            <div id="left_section">
                ...
                <div class="text_content">
                    <c:forEach items="${requestScope.shoucangList}" var="shoucang">
					   <div class="c1-bline" style="padding:7px 0px;">
					       <div class="f-left">
						     <img src="<%=path %>/img/head-mark4.gif" align="middle" class="img-vm" border="0"/> 
					             <a href="<%=path %>/yinyueDetailQian.action?id=${shoucang.yinyue.id}">${shoucang.yinyue.mingcheng}</a>
					       </div>
					      <div class="f-right">收藏时间:${shoucang.shijian}</div>
					      <div class="clear"></div>
					  </div>
					</c:forEach>    
                </div>
